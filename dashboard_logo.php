        ...
        <main>
            ...
            <table>
                ...
                <?php foreach ($select_logo_res as $key => $logo) { ?>
                    <tr>
                        <td><?=$key+1?></td>
                        <td><img width="100px" height="120px" src="./uploads/logo/<?=$logo['logo']?>" alt=""></td>

                        <td>
                            <a class="stn <?=($logo['status']==1)?'s1':'s2'?>" href="add_logo_status.php?id=<?=$logo['id']?>" 
                            >
                        ...
                        <td><a href="delete_logo.php?id=<?=$logo['id']?>" class="btn danger">Delete</a></td>
