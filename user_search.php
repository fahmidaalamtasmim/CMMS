...
<section class="search__bar">
    <form class="container search__bar-container" action="user_search.php" method="GET">
        <div>
...
<section class="posts">
    <div class="container posts__container">
        ...
        if (isset($_SESSION['search'])) { ?>
            <strong style="color:#ff3636; font-size: large; text-align:center; margin-left: 38rem;">
            ...
            <?php foreach ($s_res as $key => $event) { ?>
                <article class="post">
                    ...
                    <div class="post__info">
                        ...
                        ?>
                        <!-- query to fetch the category title -->
                        <a href="category_event.php?id=<?= $event['category_id'] ?>" class="category__button"><?= $ca['title'] ?></a>
                        <!-- title -->
                        <h3 class="post__title"><a href="single_event.php?id=<?=$event['id']?>"><?= $event['title'] ?></a></h3>
                        <!-- description -->
