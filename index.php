...
<body>
    ...
    <div class="container">
        <div class="join-us" >
            <button id="join" class="jbtn"><a href="payUs.php">JOIN US</a></button>
        </div>
    </div>
            ...
            <div class="dead">
                ...
                <?php }unset($_SESSION['msg'])?>
                    ...
                    <form action="messages_post.php" method="POST">
                        <label  >NAME:</label><br>
                        <input class="in3" type="text"  name="name" ><br>

                        <label >EMAIL:</label><br>
                        <input class="in2" type="email"  name="email"><br><br>

                        <label >YOUR MESSAGE:</label><br>
                        <input class="in1" type="text" name="msg" id="msg"><br><br>
