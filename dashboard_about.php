...
$select_about = mysqli_query($db_connection,$select);
    ...
    <div class="container dashboard__container">
        ...
        <?php } ?>
            <table>
                ...
                <tbody>
                <?php foreach ($select_about as $key => $cat) { ?>
                    <tr>
                        <td><?=$key+1?></td>
                        <td><?=$cat['address']?></td>
                        <td><?=$cat['email']?></td>
                        ...
                        <td>
                            <a class="stn <?=($cat['status']==1)?'s1':'s2'?>" href="about_status.php?id=<?=$cat['id']?>" 
                            >
                         <?=($cat['status']==1)?'Active':'Deactive'?>
                        </a></td>

                        
                        <td><a href="delete_about.php?id=<?=$cat['id']?>" class="btn danger">Delete</a></td>
                    </tr>
                    <?php }?>
                </tbody>
            </table>
