        ...
        <?php } ?>
            <table>
                ...
                <?php foreach ($st as $key => $text) { ?>
                    <tr>
                        <td><?=$key+1?></td>
                        <td><i style="font-size:30px;" class="<?=$text['icon']?>"></i></td>
                        <td><a target="_blank" href="<?=$text['link']?>"><?=$text['link']?></a></td>
                        <td>
                            <a class="stn <?=($text['status']==1)?'s1':'s2'?>" href="social_status.php?id=<?=$text['id']?>" 
                            >
                         <?=($text['status']==1)?'Active':'Deactive'?>
                        </a></td>


                        <td><a href="delete_social.php?id=<?=$text['id']?>" class="btn danger">Delete</a></td>
                    </tr>
                    <?php }?>
                </tbody>
            </table>
