 ...
 <nav>
    <div class="container nav__container">
        ...
        <ul class="nav__items">
            ...
            <li><a href="user_search.php"><b>SEARCH</b></a></li>
            <li><a href="user_profile.php"><b>PROFILE</b></a></li>
            <li><a href="schedule_form.php"><b>ADD SCHEDULE</b></a></li>
            <li><a href="schedule_dashboard.php"><b>SCHEDULE</b></a></li>
            <li><a href="chat.php?id=<?=$profile_id?>"><b>CHAT</b></a></li>
            <li class="nav__profile">
                ...
                <ul>
                    <li style="border-bottom: 3px solid black;"><a href="dashboard_user.php">DASHBOARD</a></li>

                    <li style="border-bottom: 3px solid black;"><a href="add_logo.php">LOGO</a></li>

                    <li style="border-bottom: 3px solid black;"><a href="add_text.php">TEXT</a></li>

                    <li style="border-bottom: 3px solid black;"><a href="add_home_image.php">IMAGE</a></li>

                    <li style="border-bottom: 3px solid black;"><a href="about-club.php">CLUB INFO</a></li>
                    

                    <li style="border-bottom: 3px solid black;"><a href="about.php">CONTACT</a></li>

                    <li style="border-bottom: 3px solid black;"><a href="social.php">SOCIAL ICON</a></li>

                    <li style="border-bottom: 3px solid black;"><a href="dashboard_messages.php">MESSEGES</a></li>
